...
```
dānaSeq/
├── nanopore_live/   Real-time analysis (26 scripts)
├── nanopore_mag/           MAG reconstruction (26 scripts)
...
Documentation: `nanopore_live/CRITICAL_KRAKEN_BUG.md`
...
**Real-Time Processing:**
- `nanopore_live/README.md` — Workflow guide
- `nanopore_live/CLAUDE.md` — Architecture details
...
**MAG Assembly:**
- `nanopore_mag/README.md` — Assembly methodology
