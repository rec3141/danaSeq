...
nanopore_mag/            Post-expedition genome assembly
...
**Subdirectories:**
- `nanopore_live/CLAUDE.md` — Detailed real-time pipeline architecture
- `nanopore_live/README.md` — Real-time processing guide
- `nanopore_mag/README.md` — MAG assembly methodology
