...
**File:** `nanopore_live/24_process_reads_optimized.sh:299-304`
...
**Files:**
- `nanopore_live/24_process_reads_optimized.sh` (6 instances)
- `nanopore_mag/61_map_and_bin_optimized.sh` (utility function)
...
**File:** `nanopore_live/24_process_reads_optimized.sh:147-154`
...
**File:** `nanopore_live/24_process_reads_optimized.sh:676-682`
...
**File:** `nanopore_live/24_process_reads_optimized.sh:701-708`
...
**File:** `nanopore_live/24_process_reads_optimized.sh:792-799`
...
**File:** `nanopore_mag/61_map_and_bin_optimized.sh:149-157`
