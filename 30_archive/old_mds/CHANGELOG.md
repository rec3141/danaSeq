...
│
├─ 10_realtime_processing/ (26 scripts)
...
**New Structure:**
- **10_realtime_processing/** - Real-time analysis at sea
- **20_mag_assembly/** - MAG reconstruction pipeline
- **30_archive/** - Deprecated/experimental scripts
